...
public class PersonDAO {
    ...
    public void testMultipleUpdate() {
        ...
        System.out.println("Time for multiple updates for 1000 records: " + (after - before));
    }
    ...
    public void testBatchUpdate() {
        ...
        System.out.println("Time for batch update with 1000 records: " + (after - before));
    }
    ...
    private List<Person> create1000People() {
        ...
        for (int i = 0; i < 1000; i++) {
            people.add(new Person(i, "Name-" + i, i % 50 + 18, String.format("test%d@test.com", i), "test_address"));
        }
        return people;
    }
